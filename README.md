...
[![npm](https://img.shields.io/npm/v/t-0?color=f97316)](https://www.npmjs.com/package/t-0)
...
`t-0` is the **stack CLI** (install / start / doctor). The Ratatui workspace pad is still **`t0`** (legacy `mc`).
